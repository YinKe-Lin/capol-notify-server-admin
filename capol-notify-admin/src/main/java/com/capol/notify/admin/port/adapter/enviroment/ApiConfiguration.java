...
public class ApiConfiguration {
    ...
    public Docket producerApi() {
        return buildDocket("com.capol.notify.admin.port.adapter.restapi.controller")
                .groupName("消息服务管理端API")
                .pathMapping("/")
                .apiInfo(new ApiInfoBuilder().title("消息服务管理端API").version("V1.0").description("消息服务管理端API").build());
    }
    ...
    public Jackson2ObjectMapperFactoryBean jackson2ObjectMapperFactoryBean() {
        ...
        serializers.put(BigDecimal.class, BigDecimalToStringSerializer.instance);
        jackson2ObjectMapperFactoryBean.setSerializersByType(serializers);
